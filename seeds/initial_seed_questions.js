...
exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    knex('classing_questions').insert({id: 3, question: 'Tire UTQG Treadwear less than 140?', stock_legal: null, sts_legal: false, stx_legal: false, stu_legal: false, sp_legal: null, sm_legal: null}),
    knex('classing_questions').insert({id: 4, question: 'DOT R-Compound Tire?', stock_legal: true, sts_legal: false, stx_legal: false, stu_legal: false, sp_legal: true, sm_legal: true}),
    knex('classing_questions').insert({id: 5, question: 'Changed Front Anti Roll Bar and/or Bushings?', stock_legal: true, sts_legal: true, stx_legal: true, stu_legal: true, sp_legal: true, sm_legal: true}),
    knex('classing_questions').insert({id: 6, question: 'Changed Rear Anti Roll Bar and/or Bushings?', stock_legal: false, sts_legal: true, stx_legal: true, stu_legal: true, sp_legal: true, sm_legal: true}),
    knex('classing_questions').insert({id: 7, question: 'Non-Stock Springs?', stock_legal: false, sts_legal: true, stx_legal: true, stu_legal: true, sp_legal: true, sm_legal: true}),
    knex('classing_questions').insert({id: 8, question: 'Installed Camber Plates?', stock_legal: false, sts_legal: true, stx_legal: true, stu_legal: true, sp_legal: true, sm_legal: true}),
    knex('classing_questions').insert({id: 9, question: 'Installed Front or Rear Shock Tower Brace?', stock_legal: false, sts_legal: true, stx_legal: true, stu_legal: true, sp_legal: true, sm_legal: true}),
    knex('classing_questions').insert({id: 10, question: 'Installed Shocks with Adjustable Valving?', stock_legal: true, sts_legal: true, stx_legal: true, stu_legal: true, sp_legal: true, sm_legal: true}),
    knex('classing_questions').insert({id: 11, question: 'Replaced Struts with Coil-Over Suspension?', stock_legal: false, sts_legal: true, stx_legal: true, stu_legal: true, sp_legal: true, sm_legal: true}),
    knex('classing_questions').insert({id: 12, question: 'Changed Suspension Bushing Material or Offset?', stock_legal: false, sts_legal: true, stx_legal: true, stu_legal: true, sp_legal: true, sm_legal: true}),
    knex('classing_questions').insert({id: 13, question: 'Added Track Bar or Panhard Bar?', stock_legal: false, sts_legal: true, stx_legal: true, stu_legal: true, sp_legal: true, sm_legal: true}),
